 ...
 */
public record ZoneSettings(int searchRadius, int verticalReach, boolean reorganize, boolean tidyInside, boolean dryRun) {
	public static final int MAX_SEARCH_RADIUS = 48;
	public static final int MAX_VERTICAL_REACH = 6;
	public static final ZoneSettings DEFAULT = new ZoneSettings(32, 4, true, false, false);
